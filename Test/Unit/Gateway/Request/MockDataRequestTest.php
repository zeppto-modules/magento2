 ...
 */
namespace Zeppto\Magento2\Test\Unit\Gateway\Request;
...
class MockDataRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function transactionResultsDataProvider()
    {
        return [
            [
                'forceResultCode' => ZepptoMagento2Client::SUCCESS,
                'transactionResult' => null
            ],
            [
                'forceResultCode' => ZepptoMagento2Client::SUCCESS,
                'transactionResult' => ZepptoMagento2Client::SUCCESS
            ],
            [
                'forceResultCode' => ZepptoMagento2Client::FAILURE,
                'transactionResult' => ZepptoMagento2Client::FAILURE
            ]
        ];
    }
}
